...
_uartGetCharacter_result_10000_75:
	.ds 1
_main_initial_char_10001_116:
	.ds 1
_main_result_50001_126:
	.ds 1
_main_received_payload_10002_118:
	.ds 1
_main_register_current_value_10002_118:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;initial_char              Allocated with name '_main_initial_char_10001_116'
;__300010007               Allocated with name '_main___300010007_30001_117'
;__300010008               Allocated with name '_main___300010008_30001_124'
;__300010009               Allocated with name '_main___300010009_30001_124'
;uart                      Allocated with name '_main_uart_40001_125'
;blocking                  Allocated with name '_main_blocking_40001_125'
;result                    Allocated with name '_main_result_50001_126'
;received_payload          Allocated with name '_main_received_payload_10002_118'
;register_current_value    Allocated with name '_main_register_current_value_10002_118'
;i                         Allocated with name '_main_i_20002_119'
;------------------------------------------------------------
...
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
;	main.c:6: INIT_EXTENDED_SFR();
	orl	_P_SW2,#0x80
;	main.c:7: EA = 1; // enable interrupts
;	assignBit
	setb	_EA
;	main.c:11: CONSOLE_PIN_CONFIG
...
;	main.c:13: gpio_init();
	lcall	_gpio_init
;	main.c:16: uint8_t initial_char = '0';
	mov	dptr,#_main_initial_char_10001_116
	mov	a,#0x30
	movx	@dptr,a
;	main.c:17: while (initial_char != 's') {
00101$:
	mov	dptr,#_main_initial_char_10001_116
	movx	a,@dptr
	mov	r7,a
...
;	/Users/ambadran717/.stc/uni-stc/hal/uart-hal.h:189: return result;
	mov	dptr,#_main_result_50001_126
	movx	a,@dptr
;	main.c:18: initial_char = uartGetCharacter(CONSOLE_UART, NON_BLOCKING);
	mov	dptr,#_main_initial_char_10001_116
	movx	@dptr,a
	sjmp	00101$
00103$:
;	main.c:20: uartSendBlock(CONSOLE_UART, "Starting..\n", 12, NON_BLOCKING);
...
;	main.c:23: nrf24_device(RECEIVER, RESET);
	mov	dptr,#_nrf24_device_PARM_2
	mov	a,#0x01
	movx	@dptr,a
	mov	dpl, #0x01
	lcall	_nrf24_device
;	main.c:30: for (int i=0; i<24; i++) {
	mov	r6,#0x00
	mov	r7,#0x00
00113$:
	clr	c
	...
	subb	a,#0x80
	jnc	00109$
;	main.c:31: nrf24_read(i, &register_current_value, 1, CLOSE);
	mov	ar5,r6
	mov	dptr,#_nrf24_read_PARM_2
	mov	a,#_main_register_current_value_10002_118
	movx	@dptr,a
	mov	a,#(_main_register_current_value_10002_118 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	pop	ar6
	pop	ar7
;	main.c:32: printf("\rRegister %d: %d\n", i, register_current_value);
	mov	dptr,#_main_register_current_value_10002_118
	movx	a,@dptr
	mov	r5,a
	mov	r4,#0x00
	push	ar7
...
;	main.c:36: while (1) {
	...
	sjmp	00113$
00109$:
;	main.c:42: if (nrf24_receive(&received_payload, 1) != RECEIVE_FIFO_EMPTY) {  
	mov	dptr,#_nrf24_receive_PARM_2
	mov	a,#0x01
	movx	@dptr,a
	mov	dptr,#_main_received_payload_10002_118
	mov	b, #0x00
	lcall	_nrf24_receive
	mov	r7, dpl
	cjne	r7,#0x02,00109$
;	main.c:48: printf("\rReceived Value: %d  ", received_payload);
	mov	dptr,#_main_received_payload_10002_118
	movx	a,@dptr
	mov	r7,a
	mov	r6,#0x00
