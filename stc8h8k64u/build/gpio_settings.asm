...
_gpio_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	gpio_settings.c:8: gpioConfigure(&tssstt);
	mov	dptr,#_tssstt
	mov	b, #0x00
	lcall	_gpioConfigure
;	gpio_settings.c:9: tssstt_off();
;	gpio_settings.c:11: return;
;	gpio_settings.c:12: }
	ljmp	_tssstt_off
;------------------------------------------------------------
;Allocation info for local variables in function 'tssstt_on'
;------------------------------------------------------------
;	gpio_settings.c:14: void tssstt_on(void) {
;	-----------------------------------------
;	 function tssstt_on
;	-----------------------------------------
_tssstt_on:
;	gpio_settings.c:15: gpioWrite(&tssstt, 1);
...
;	gpio_settings.c:16: }
	ljmp	_gpioWrite
;------------------------------------------------------------
;Allocation info for local variables in function 'tssstt_off'
;------------------------------------------------------------
;	gpio_settings.c:18: void tssstt_off(void) {
;	-----------------------------------------
;	 function tssstt_off
;	-----------------------------------------
_tssstt_off:
;	gpio_settings.c:19: gpioWrite(&tssstt, 0);
	mov	dptr,#_gpioWrite_PARM_2
	clr	a
	movx	@dptr,a
	mov	dptr,#_tssstt
