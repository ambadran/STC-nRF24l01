...
_uartGetCharacter_result_10000_75:
	.ds 1
_SPI_command:
	.ds 1
...
_current_payload_width:
	.ds 1
_delay_function_duration_ms_10000_114:
	.ds 4
_nrf24_SPI_input_10000_120:
	.ds 1
_SPI_send_command_command_10000_122:
	.ds 1
_SPI_send_command_spi_byte_10000_123:
	.ds 1
_nrf24_CE_input_10000_124:
	.ds 1
_nrf24_dynamic_ack_state_10000_126:
	.ds 1
_nrf24_transmit_PARM_2:
	.ds 1
_nrf24_transmit_PARM_3:
	.ds 1
_nrf24_transmit_payload_10000_130:
	.ds 3
_nrf24_send_payload_PARM_2:
	.ds 1
_nrf24_send_payload_payload_10000_134:
	.ds 3
_nrf24_receive_PARM_2:
	.ds 1
_nrf24_receive_payload_10000_142:
	.ds 3
_nrf24_flush_fifo_select_10000_150:
	.ds 1
_nrf24_device_PARM_2:
	.ds 1
_nrf24_device_device_mode_10000_157:
	.ds 1
_nrf24_device_hardwareCheckPassed_10001_159:
	.ds 1
_nrf24_device_new_value_10001_159:
	.ds 1
_nrf24_automatic_retransmit_setup_PARM_2:
	.ds 1
_nrf24_automatic_retransmit_setup_delay_time_10000_165:
	.ds 2
_nrf24_auto_acknowledgment_setup_datapipe_10000_168:
	.ds 1
_nrf24_dynamic_payload_PARM_2:
	.ds 1
_nrf24_dynamic_payload_state_10000_170:
	.ds 1
_nrf24_datapipe_ptx_datapipe_number_10000_174:
	.ds 1
_nrf24_prx_static_payload_width_PARM_2:
	.ds 1
_nrf24_prx_static_payload_width_static_payload_width_10000_180:
	.ds 1
_nrf24_datapipe_enable_number_of_datapipes_10000_184:
	.ds 1
_nrf24_address_width_address_width_10000_186:
	.ds 1
_nrf24_rf_datarate_rf_datarate_10000_190:
	.ds 2
_nrf24_rf_power_rf_power_10000_193:
	.ds 1
_nrf24_rf_channel_rf_channel_10000_196:
	.ds 1
_nrf24_rf_channel_write_pointer_20000_198:
	.ds 1
_nrf24_rf_channel_write_pointer_20000_199:
	.ds 1
_nrf24_interrupt_mask_PARM_2:
	.ds 1
_nrf24_interrupt_mask_PARM_3:
	.ds 1
_nrf24_interrupt_mask_rx_mask_10000_200:
	.ds 1
_nrf24_crc_configuration_PARM_2:
	.ds 1
_nrf24_crc_configuration_crc_enable_10000_202:
	.ds 1
_nrf24_mode_mode_10000_204:
	.ds 1
_nrf24_read_PARM_2:
	.ds 3
_nrf24_read_PARM_3:
...
_nrf24_write_PARM_4:
	.ds 1
_nrf24_write_address_10000_211:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;duration_ms               Allocated with name '_delay_function_duration_ms_10000_114'
;------------------------------------------------------------
...
_delay_function:
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_delay_function_duration_ms_10000_114
	mov	a,r7
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;------------------------------------------------------------
;input                     Allocated with name '_nrf24_SPI_input_10000_120'
;------------------------------------------------------------
...
_nrf24_SPI:
	mov	a,dpl
	mov	dptr,#_nrf24_SPI_input_10000_120
	movx	@dptr,a
...
;------------------------------------------------------------
;command                   Allocated with name '_SPI_send_command_command_10000_122'
;spi_byte                  Allocated with name '_SPI_send_command_spi_byte_10000_123'
;------------------------------------------------------------
...
_SPI_send_command:
	mov	a,dpl
	mov	dptr,#_SPI_send_command_command_10000_122
	movx	@dptr,a
;	nrf24l01.c:107: uint8_t spi_byte = bitReverseTable256[command];
	movx	a,@dptr
	mov	dptr,#_bitReverseTable256
	movc	a,@a+dptr
	mov	dptr,#_SPI_send_command_spi_byte_10000_123
	movx	@dptr,a
...
;------------------------------------------------------------
;input                     Allocated with name '_nrf24_CE_input_10000_124'
;------------------------------------------------------------
...
_nrf24_CE:
	mov	a,dpl
	mov	dptr,#_nrf24_CE_input_10000_124
	movx	@dptr,a
...
;------------------------------------------------------------
;state                     Allocated with name '_nrf24_dynamic_ack_state_10000_126'
;------------------------------------------------------------
...
_nrf24_dynamic_ack:
	mov	a,dpl
	mov	dptr,#_nrf24_dynamic_ack_state_10000_126
	movx	@dptr,a
...
;payload                   Allocated with name '_nrf24_transmit_payload_10000_130'
;------------------------------------------------------------
...
_nrf24_transmit:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_nrf24_transmit_payload_10000_130
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;payload                   Allocated with name '_nrf24_send_payload_payload_10000_134'
;------------------------------------------------------------
...
_nrf24_send_payload:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_nrf24_send_payload_payload_10000_134
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;payload                   Allocated with name '_nrf24_receive_payload_10000_142'
;------------------------------------------------------------
...
_nrf24_receive:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_nrf24_receive_payload_10000_142
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;	nrf24l01.c:218: SPI_command = NOP_CMD;
	...
	mov	a,#0xff
	movx	@dptr,a
;	nrf24l01.c:219: *payload = bitReverseTable256[SPI_send_command(SPI_command)]; // newly added
	mov	dpl, #0xff
	push	ar7
	push	ar6
	push	ar5
...
;------------------------------------------------------------
;fifo_select               Allocated with name '_nrf24_flush_fifo_select_10000_150'
;------------------------------------------------------------
...
_nrf24_flush:
	mov	a,dpl
	mov	dptr,#_nrf24_flush_fifo_select_10000_150
	movx	@dptr,a
...
;device_mode               Allocated with name '_nrf24_device_device_mode_10000_157'
;register_to_write_to      Allocated with name '_nrf24_device_register_to_write_to_10001_159'
;hardwareCheckPassed       Allocated with name '_nrf24_device_hardwareCheckPassed_10001_159'
;new_value                 Allocated with name '_nrf24_device_new_value_10001_159'
;------------------------------------------------------------
...
_nrf24_device:
	mov	a,dpl
	mov	dptr,#_nrf24_device_device_mode_10000_157
	movx	@dptr,a
...
;	nrf24l01.c:341: bool hardwareCheckPassed = false;
	mov	dptr,#_nrf24_device_hardwareCheckPassed_10001_159
	clr	a
	movx	@dptr,a
...
;	nrf24l01.c:349: new_value = register_current_value + 3;
	...
	inc	r7
	inc	r7
	mov	dptr,#_nrf24_device_new_value_10001_159
	mov	a,r7
	movx	@dptr,a
...
;delay_time                Allocated with name '_nrf24_automatic_retransmit_setup_delay_time_10000_165'
;------------------------------------------------------------
;	nrf24l01.c:404: void nrf24_automatic_retransmit_setup(uint16_t delay_time, uint8_t retransmit_count)
;	-----------------------------------------
...
_nrf24_automatic_retransmit_setup:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_nrf24_automatic_retransmit_setup_delay_time_10000_165
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	nrf24l01.c:406: register_new_value = 0x00;
	mov	dptr,#_register_new_value
	clr	a
	movx	@dptr,a
00108$:
;	nrf24l01.c:407: for (; (delay_time > 250) && (register_new_value < 0X0F); delay_time -= 250)
	mov	dptr,#_nrf24_automatic_retransmit_setup_delay_time_10000_165
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00143$:
	jnc	00101$
;	nrf24l01.c:408: register_new_value++;
	mov	dptr,#_register_new_value
	mov	a,r5
	inc	a
	movx	@dptr,a
;	nrf24l01.c:407: for (; (delay_time > 250) && (register_new_value < 0X0F); delay_time -= 250)
	...
	sjmp	00108$
00101$:
;	nrf24l01.c:409: register_new_value <<= ARD_0;
	mov	dptr,#_register_new_value
	movx	a,@dptr
	swap	a
	anl	a,#0xf0
	movx	@dptr,a
;	nrf24l01.c:410: if ((retransmit_count > 0) && (retransmit_count < 16))
	mov	dptr,#_nrf24_automatic_retransmit_setup_PARM_2
	movx	a,@dptr
	mov	r7,a
	jz	00103$
...
00146$:
	jnc	00103$
;	nrf24l01.c:411: register_new_value |= retransmit_count;
	mov	dptr,#_register_new_value
	movx	a,@dptr
	orl	a,r7
	movx	@dptr,a
;	nrf24l01.c:413: register_new_value |= 0;
00103$:
;	nrf24l01.c:414: nrf24_write(SETUP_RETR_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
...
;------------------------------------------------------------
;datapipe                  Allocated with name '_nrf24_auto_acknowledgment_setup_datapipe_10000_168'
;------------------------------------------------------------
;	nrf24l01.c:418: void nrf24_auto_acknowledgment_setup(uint8_t datapipe)
;	-----------------------------------------
;	 function nrf24_auto_acknowledgment_setup
;	-----------------------------------------
_nrf24_auto_acknowledgment_setup:
	mov	a,dpl
	mov	dptr,#_nrf24_auto_acknowledgment_setup_datapipe_10000_168
	movx	@dptr,a
;	nrf24l01.c:420: if (datapipe < 7)
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x07,00111$
00111$:
	jnc	00102$
;	nrf24l01.c:421: register_new_value = (1 << datapipe) - 1;
	mov	b,r7
	inc	b
	mov	a,#0x01
	sjmp	00114$
...
00114$:
	...
	movx	@dptr,a
00102$:
;	nrf24l01.c:422: nrf24_write(EN_AA_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
...
;state                     Allocated with name '_nrf24_dynamic_payload_state_10000_170'
;------------------------------------------------------------
;	nrf24l01.c:426: void nrf24_dynamic_payload(uint8_t state, uint8_t datapipe)
;	-----------------------------------------
;	 function nrf24_dynamic_payload
;	-----------------------------------------
_nrf24_dynamic_payload:
	mov	a,dpl
	mov	dptr,#_nrf24_dynamic_payload_state_10000_170
	movx	@dptr,a
;	nrf24l01.c:428: nrf24_auto_acknowledgment_setup(datapipe);                        /*setting auto acknowledgment before setting dynamic payload*/
	mov	dptr,#_nrf24_dynamic_payload_PARM_2
	movx	a,@dptr
	mov	r7,a
	mov	dpl,a
	push	ar7
	lcall	_nrf24_auto_acknowledgment_setup
;	nrf24l01.c:429: nrf24_read(FEATURE_ADDRESS, &register_current_value, 1, CLOSE);
	mov	dptr,#_nrf24_read_PARM_2
	mov	a,#_register_current_value
	movx	@dptr,a
	mov	a,#(_register_current_value >> 8)
	...
	lcall	_nrf24_read
	pop	ar7
;	nrf24l01.c:430: if (state == ENABLE)
	mov	dptr,#_nrf24_dynamic_payload_state_10000_170
	movx	a,@dptr
	mov	r6,a
	cjne	r6,#0x01,00104$
;	nrf24l01.c:432: register_new_value = register_current_value | (1 << EN_DPL);    /*EN_DPL bit turns dynamic payload width on or off on all datapipes*/
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x04
	movx	@dptr,a
;	nrf24l01.c:433: nrf24_write(FEATURE_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
	...
	lcall	_nrf24_write
	pop	ar7
;	nrf24l01.c:434: if (datapipe < 7)
	cjne	r7,#0x07,00122$
00122$:
	jnc	00102$
;	nrf24l01.c:435: register_new_value = (1 << datapipe) - 1;                       /*turning on dynamic payload width on chosen datapipes, using DYNPD register*/
	mov	b,r7
	inc	b
	mov	a,#0x01
	sjmp	00125$
...
00125$:
	...
	movx	@dptr,a
00102$:
;	nrf24l01.c:436: nrf24_write(DYNPD_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
	...
	mov	dpl, #0x1c
	lcall	_nrf24_write
;	nrf24l01.c:437: dynamic_payload = ENABLE;
	mov	dptr,#_dynamic_payload
	mov	a,#0x01
	movx	@dptr,a
	ret
00104$:
;	nrf24l01.c:441: register_new_value = register_current_value & (~(1 << EN_DPL));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	anl	a,#0xfb
	movx	@dptr,a
;	nrf24l01.c:442: nrf24_write(FEATURE_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
	...
	mov	dpl, #0x1d
	lcall	_nrf24_write
;	nrf24l01.c:443: dynamic_payload = DISABLE;
	mov	dptr,#_dynamic_payload
	clr	a
	movx	@dptr,a
;	nrf24l01.c:445: }
...
;------------------------------------------------------------
;datapipe_number           Allocated with name '_nrf24_datapipe_ptx_datapipe_number_10000_174'
;------------------------------------------------------------
;	nrf24l01.c:448: void nrf24_datapipe_ptx(uint8_t datapipe_number)
;	-----------------------------------------
;	 function nrf24_datapipe_ptx
;	-----------------------------------------
_nrf24_datapipe_ptx:
	mov	a,dpl
	mov	dptr,#_nrf24_datapipe_ptx_datapipe_number_10000_174
	movx	@dptr,a
;	nrf24l01.c:450: nrf24_write(TX_ADDR_ADDRESS, &datapipe_address[datapipe_number - 1][0], current_address_width, CLOSE);
	movx	a,@dptr
	mov	r7,a
	dec	r7
	clr	F0
...
;------------------------------------------------------------
;address                   Allocated with name '_nrf24_datapipe_address_configuration_address_10000_177'
;counter                   Allocated with name '_nrf24_datapipe_address_configuration_counter_20000_178'
;------------------------------------------------------------
;	nrf24l01.c:454: void nrf24_datapipe_address_configuration(void)
;	-----------------------------------------
;	 function nrf24_datapipe_address_configuration
;	-----------------------------------------
_nrf24_datapipe_address_configuration:
;	nrf24l01.c:458: for (uint8_t counter = 0; counter < 2; counter++) // only write the first two
	mov	r7,#0x0a
	mov	r6,#0x00
00103$:
	cjne	r6,#0x02,00120$
00120$:
	jnc	00105$
;	nrf24l01.c:460: nrf24_write(address, &datapipe_address[counter][0], current_address_width, CLOSE);
	mov	a,r6
	mov	b,#0x05
	mul	ab
	add	a, #_datapipe_address
...
;static_payload_width      Allocated with name '_nrf24_prx_static_payload_width_static_payload_width_10000_180'
;address                   Allocated with name '_nrf24_prx_static_payload_width_address_20000_182'
;------------------------------------------------------------
;	nrf24l01.c:466: void nrf24_prx_static_payload_width(uint8_t static_payload_width, uint8_t number_of_datapipes)
;	-----------------------------------------
;	 function nrf24_prx_static_payload_width
;	-----------------------------------------
_nrf24_prx_static_payload_width:
	mov	a,dpl
	mov	dptr,#_nrf24_prx_static_payload_width_static_payload_width_10000_180
	movx	@dptr,a
;	nrf24l01.c:468: for (uint8_t address = RX_PW_P0_ADDRESS; number_of_datapipes; number_of_datapipes--)
	mov	r7,#0x11
	mov	dptr,#_nrf24_prx_static_payload_width_PARM_2
	movx	a,@dptr
	mov	r6,a
00103$:
	mov	a,r6
	jz	00101$
;	nrf24l01.c:470: nrf24_write(address, &static_payload_width, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_nrf24_prx_static_payload_width_static_payload_width_10000_180
	movx	@dptr,a
	mov	a,#(_nrf24_prx_static_payload_width_static_payload_width_10000_180 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	nrf24l01.c:468: for (uint8_t address = RX_PW_P0_ADDRESS; number_of_datapipes; number_of_datapipes--)
	...
	sjmp	00103$
00101$:
;	nrf24l01.c:473: current_payload_width = static_payload_width;
	mov	dptr,#_nrf24_prx_static_payload_width_static_payload_width_10000_180
	movx	a,@dptr
	mov	dptr,#_current_payload_width
	movx	@dptr,a
...
;------------------------------------------------------------
;number_of_datapipes       Allocated with name '_nrf24_datapipe_enable_number_of_datapipes_10000_184'
;------------------------------------------------------------
;	nrf24l01.c:477: void nrf24_datapipe_enable(uint8_t number_of_datapipes)
;	-----------------------------------------
;	 function nrf24_datapipe_enable
;	-----------------------------------------
_nrf24_datapipe_enable:
	mov	a,dpl
	mov	dptr,#_nrf24_datapipe_enable_number_of_datapipes_10000_184
	movx	@dptr,a
;	nrf24l01.c:479: register_new_value = (1 << number_of_datapipes) - 1;
	movx	a,@dptr
	mov	r7,a
	mov	b,r7
	inc	b
...
00104$:
	...
	mov	dptr,#_register_new_value
	movx	@dptr,a
;	nrf24l01.c:480: nrf24_write(EN_RXADDR_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
...
;------------------------------------------------------------
;address_width             Allocated with name '_nrf24_address_width_address_width_10000_186'
;------------------------------------------------------------
;	nrf24l01.c:484: void nrf24_address_width(uint8_t address_width)
;	-----------------------------------------
;	 function nrf24_address_width
;	-----------------------------------------
_nrf24_address_width:
	mov	a,dpl
	mov	dptr,#_nrf24_address_width_address_width_10000_186
	movx	@dptr,a
...
00120$:
	jc	00102$
;	nrf24l01.c:488: write_pointer = address_width - 2;
	mov	a,r7
	add	a,#0xfe
	...
	sjmp	00103$
00102$:
;	nrf24l01.c:492: write_pointer = 3;
	mov	dptr,#_write_pointer
	mov	a,#0x03
	movx	@dptr,a
00103$:
;	nrf24l01.c:494: nrf24_write(SETUP_AW_ADDRESS, &write_pointer, 1, CLOSE);                    /*5 bytes is the maximum address width available*/
	mov	dptr,#_nrf24_write_PARM_2
	...
	mov	dpl, #0x03
	lcall	_nrf24_write
;	nrf24l01.c:495: current_address_width = address_width;
	mov	dptr,#_nrf24_address_width_address_width_10000_186
	movx	a,@dptr
	mov	dptr,#_current_address_width
	movx	@dptr,a
...
;------------------------------------------------------------
;rf_datarate               Allocated with name '_nrf24_rf_datarate_rf_datarate_10000_190'
;------------------------------------------------------------
;	nrf24l01.c:499: void nrf24_rf_datarate(uint16_t rf_datarate)
;	-----------------------------------------
...
_nrf24_rf_datarate:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_nrf24_rf_datarate_rf_datarate_10000_190
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	nrf24l01.c:501: nrf24_read(RF_SETUP_ADDRESS, &register_current_value, 1, CLOSE);
	mov	dptr,#_nrf24_read_PARM_2
	mov	a,#_register_current_value
	movx	@dptr,a
	mov	a,#(_register_current_value >> 8)
	...
	mov	dpl, #0x06
	lcall	_nrf24_read
;	nrf24l01.c:502: register_current_value &= ~((1 << RF_DR_LOW) | (1 << RF_DR_HIGH));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	anl	acc,#0xd7
	movx	@dptr,a
;	nrf24l01.c:503: switch (rf_datarate)
	mov	dptr,#_nrf24_rf_datarate_rf_datarate_10000_190
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00127$:
	cjne	r6,#0xd0,00104$
	cjne	r7,#0x07,00104$
;	nrf24l01.c:506: register_new_value = register_current_value | (1 << RF_DR_HIGH);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x08
	movx	@dptr,a
;	nrf24l01.c:507: break;
;	nrf24l01.c:508: case 1000:
	sjmp	00105$
00102$:
;	nrf24l01.c:509: register_new_value = register_current_value;
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	movx	@dptr,a
;	nrf24l01.c:510: break;
;	nrf24l01.c:511: case 250:
	sjmp	00105$
00103$:
;	nrf24l01.c:512: register_new_value = register_current_value | (1 << RF_DR_LOW);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x20
	movx	@dptr,a
;	nrf24l01.c:513: break;
;	nrf24l01.c:514: default:
	sjmp	00105$
00104$:
;	nrf24l01.c:515: register_new_value = register_current_value;
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	movx	@dptr,a
;	nrf24l01.c:517: }
00105$:
;	nrf24l01.c:518: nrf24_write(RF_SETUP_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
...
;------------------------------------------------------------
;rf_power                  Allocated with name '_nrf24_rf_power_rf_power_10000_193'
;------------------------------------------------------------
;	nrf24l01.c:522: void nrf24_rf_power(uint8_t rf_power)
;	-----------------------------------------
;	 function nrf24_rf_power
;	-----------------------------------------
_nrf24_rf_power:
	mov	a,dpl
	mov	dptr,#_nrf24_rf_power_rf_power_10000_193
	movx	@dptr,a
;	nrf24l01.c:524: nrf24_read(RF_SETUP_ADDRESS, &register_current_value, 1, CLOSE);
	mov	dptr,#_nrf24_read_PARM_2
	mov	a,#_register_current_value
	movx	@dptr,a
	mov	a,#(_register_current_value >> 8)
	...
	mov	dpl, #0x06
	lcall	_nrf24_read
;	nrf24l01.c:525: register_current_value &= ~((1 << RF_PWR_1) | (1 << RF_PWR_0));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	anl	acc,#0xf9
	movx	@dptr,a
;	nrf24l01.c:526: switch (rf_power)
	mov	dptr,#_nrf24_rf_power_rf_power_10000_193
	movx	a,@dptr
	mov	r7,a
	jz	00101$
...
00134$:
	...
	sjmp	00103$
00135$:
;	nrf24l01.c:528: case 0:
	cjne	r7,#0x12,00105$
	sjmp	00104$
00101$:
;	nrf24l01.c:529: register_new_value = register_current_value | ((1 << RF_PWR_1) | (1 << RF_PWR_0));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x06
	movx	@dptr,a
;	nrf24l01.c:530: break;
;	nrf24l01.c:531: case 6:
	sjmp	00106$
00102$:
;	nrf24l01.c:532: register_new_value = register_current_value | (1 << RF_PWR_1);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x04
	movx	@dptr,a
;	nrf24l01.c:533: break;
;	nrf24l01.c:534: case 12:
	sjmp	00106$
00103$:
;	nrf24l01.c:535: register_new_value = register_current_value | (1 << RF_PWR_0);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x02
	movx	@dptr,a
;	nrf24l01.c:536: break;
;	nrf24l01.c:537: case 18:
	sjmp	00106$
00104$:
;	nrf24l01.c:538: register_new_value = register_current_value;
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	movx	@dptr,a
;	nrf24l01.c:539: break;
;	nrf24l01.c:540: default:
	sjmp	00106$
00105$:
;	nrf24l01.c:541: register_new_value = register_current_value | (1 << RF_PWR_1);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x04
...
;	nrf24l01.c:543: }
00106$:
;	nrf24l01.c:544: nrf24_write(RF_SETUP_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
...
;------------------------------------------------------------
;rf_channel                Allocated with name '_nrf24_rf_channel_rf_channel_10000_196'
;write_pointer             Allocated with name '_nrf24_rf_channel_write_pointer_20000_198'
;write_pointer             Allocated with name '_nrf24_rf_channel_write_pointer_20000_199'
;------------------------------------------------------------
;	nrf24l01.c:548: void nrf24_rf_channel(uint8_t rf_channel)
;	-----------------------------------------
;	 function nrf24_rf_channel
;	-----------------------------------------
_nrf24_rf_channel:
	mov	a,dpl
	mov	dptr,#_nrf24_rf_channel_rf_channel_10000_196
	movx	@dptr,a
;	nrf24l01.c:550: if ((rf_channel <= 125) && (rf_channel >= 1))
	movx	a,@dptr
	mov  r7,a
	add	a,#0xff - 0x7d
	jc	00102$
...
00120$:
	jc	00102$
;	nrf24l01.c:552: uint8_t write_pointer = rf_channel;
	mov	dptr,#_nrf24_rf_channel_write_pointer_20000_198
	mov	a,r7
	movx	@dptr,a
;	nrf24l01.c:553: nrf24_write(RF_CH_ADDRESS, &write_pointer, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_nrf24_rf_channel_write_pointer_20000_198
	movx	@dptr,a
	mov	a,#(_nrf24_rf_channel_write_pointer_20000_198 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	ljmp	_nrf24_write
00102$:
;	nrf24l01.c:557: uint8_t write_pointer = 1;
	mov	dptr,#_nrf24_rf_channel_write_pointer_20000_199
	mov	a,#0x01
	movx	@dptr,a
;	nrf24l01.c:558: nrf24_write(RF_CH_ADDRESS, &write_pointer, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_nrf24_rf_channel_write_pointer_20000_199
	movx	@dptr,a
	mov	a,#(_nrf24_rf_channel_write_pointer_20000_199 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;rx_mask                   Allocated with name '_nrf24_interrupt_mask_rx_mask_10000_200'
;------------------------------------------------------------
;	nrf24l01.c:563: void nrf24_interrupt_mask(uint8_t rx_mask, uint8_t tx_mask, uint8_t max_rt_mask)
;	-----------------------------------------
;	 function nrf24_interrupt_mask
;	-----------------------------------------
_nrf24_interrupt_mask:
	mov	a,dpl
	mov	dptr,#_nrf24_interrupt_mask_rx_mask_10000_200
	movx	@dptr,a
;	nrf24l01.c:565: nrf24_read(CONFIG_ADDRESS, &register_current_value, 1, CLOSE);
	mov	dptr,#_nrf24_read_PARM_2
	mov	a,#_register_current_value
	movx	@dptr,a
	mov	a,#(_register_current_value >> 8)
	...
	mov	dpl, #0x00
	lcall	_nrf24_read
;	nrf24l01.c:566: if (rx_mask)
	mov	dptr,#_nrf24_interrupt_mask_rx_mask_10000_200
	movx	a,@dptr
	jz	00102$
;	nrf24l01.c:567: register_new_value = (register_current_value) | (1 << MASK_RX_DR);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x40
	...
	sjmp	00103$
00102$:
;	nrf24l01.c:569: register_new_value &= (~(1 << MASK_RX_DR));
	mov	dptr,#_register_new_value
	movx	a,@dptr
	anl	acc,#0xbf
	movx	@dptr,a
00103$:
;	nrf24l01.c:570: if (tx_mask)
	mov	dptr,#_nrf24_interrupt_mask_PARM_2
	movx	a,@dptr
	jz	00105$
;	nrf24l01.c:571: register_new_value |= (1 << MASK_TX_DS);
	mov	dptr,#_register_new_value
	movx	a,@dptr
	orl	acc,#0x20
	movx	@dptr,a
	sjmp	00106$
00105$:
;	nrf24l01.c:573: register_new_value &= (~(1 << MASK_TX_DS));
	mov	dptr,#_register_new_value
	movx	a,@dptr
	anl	acc,#0xdf
	movx	@dptr,a
00106$:
;	nrf24l01.c:574: if (max_rt_mask)
	mov	dptr,#_nrf24_interrupt_mask_PARM_3
	movx	a,@dptr
	jz	00108$
;	nrf24l01.c:575: register_new_value |= (1 << MASK_MAX_RT);
	mov	dptr,#_register_new_value
	movx	a,@dptr
	orl	acc,#0x10
	movx	@dptr,a
	sjmp	00109$
00108$:
;	nrf24l01.c:577: register_new_value &= (~(1 << MASK_MAX_RT));
	mov	dptr,#_register_new_value
	movx	a,@dptr
	anl	acc,#0xef
	movx	@dptr,a
00109$:
;	nrf24l01.c:579: nrf24_write(CONFIG_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
...
;crc_enable                Allocated with name '_nrf24_crc_configuration_crc_enable_10000_202'
;------------------------------------------------------------
;	nrf24l01.c:583: void nrf24_crc_configuration(uint8_t crc_enable, uint8_t crc_encoding_scheme)
;	-----------------------------------------
;	 function nrf24_crc_configuration
;	-----------------------------------------
_nrf24_crc_configuration:
	mov	a,dpl
	mov	dptr,#_nrf24_crc_configuration_crc_enable_10000_202
	movx	@dptr,a
;	nrf24l01.c:585: nrf24_read(CONFIG_ADDRESS, &register_current_value, 1, CLOSE);
	mov	dptr,#_nrf24_read_PARM_2
	mov	a,#_register_current_value
	movx	@dptr,a
	mov	a,#(_register_current_value >> 8)
	...
	mov	dpl, #0x00
	lcall	_nrf24_read
;	nrf24l01.c:586: if (crc_enable)
	mov	dptr,#_nrf24_crc_configuration_crc_enable_10000_202
	movx	a,@dptr
	jz	00102$
;	nrf24l01.c:587: register_new_value = (register_current_value) | (1 << EN_CRC);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x08
	...
	sjmp	00103$
00102$:
;	nrf24l01.c:589: register_new_value &= (~(1 << EN_CRC));
	mov	dptr,#_register_new_value
	movx	a,@dptr
	anl	acc,#0xf7
	movx	@dptr,a
00103$:
;	nrf24l01.c:590: if (crc_encoding_scheme == 2)
	mov	dptr,#_nrf24_crc_configuration_PARM_2
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x02,00105$
;	nrf24l01.c:591: register_new_value |= (1 << CRCO);
	mov	dptr,#_register_new_value
	movx	a,@dptr
	orl	acc,#0x04
	movx	@dptr,a
	sjmp	00106$
00105$:
;	nrf24l01.c:593: register_new_value &= (~(1 << CRCO));
	mov	dptr,#_register_new_value
	movx	a,@dptr
	anl	acc,#0xfb
	movx	@dptr,a
00106$:
;	nrf24l01.c:595: nrf24_write(CONFIG_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
...
;------------------------------------------------------------
;mode                      Allocated with name '_nrf24_mode_mode_10000_204'
;------------------------------------------------------------
;	nrf24l01.c:599: void nrf24_mode(uint8_t mode)
;	-----------------------------------------
;	 function nrf24_mode
;	-----------------------------------------
_nrf24_mode:
	mov	a,dpl
	mov	dptr,#_nrf24_mode_mode_10000_204
	movx	@dptr,a
;	nrf24l01.c:601: nrf24_read(CONFIG_ADDRESS, &register_current_value, 1, CLOSE);
	mov	dptr,#_nrf24_read_PARM_2
	mov	a,#_register_current_value
	movx	@dptr,a
	mov	a,#(_register_current_value >> 8)
...
00117$:
	...
	ljmp	00104$
	ljmp	00105$
;	nrf24l01.c:604: case POWER_DOWN:
00101$:
;	nrf24l01.c:605: nrf24_CE(CE_OFF);
	mov	dpl, #0x00
	push	ar7
	lcall	_nrf24_CE
;	nrf24l01.c:606: register_new_value = (register_current_value) & (~(1 << PWR_UP));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	anl	a,#0xfd
	movx	@dptr,a
;	nrf24l01.c:607: delay_function(POWER_DOWN_DELAY);
	mov	dptr,#0x0002
	clr	a
	mov	b,a
	lcall	_delay_function
	pop	ar7
;	nrf24l01.c:608: break;
	ljmp	00107$
;	nrf24l01.c:609: case STANDBYI:                                 /*standby I is defined by 'PWR_UP = 1' and 'CE pin LOW'*/
00102$:
;	nrf24l01.c:610: nrf24_CE(CE_OFF);
	mov	dpl, #0x00
	push	ar7
	lcall	_nrf24_CE
;	nrf24l01.c:611: register_new_value = (register_current_value) | (1 << PWR_UP);
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	orl	a,#0x02
	movx	@dptr,a
;	nrf24l01.c:612: delay_function(STANDBYI_DELAY);
	mov	dptr,#0x0002
	clr	a
	mov	b,a
	lcall	_delay_function
	pop	ar7
;	nrf24l01.c:613: break;
	ljmp	00107$
;	nrf24l01.c:614: case STANDBYII:                                 /*standby ii is related to a ptx device*/
00103$:
;	nrf24l01.c:615: nrf24_CE(CE_ON);
	mov	dpl, #0x01
	push	ar7
	lcall	_nrf24_CE
;	nrf24l01.c:616: register_new_value = ((register_current_value) | (1 << PWR_UP)) & (~(1 << PRIM_RX));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	orl	a,#0x02
	mov	dptr,#_register_new_value
	anl	a,#0xfe
	movx	@dptr,a
;	nrf24l01.c:617: delay_function(STANDBYI_DELAY);
	mov	dptr,#0x0002
	clr	a
	mov	b,a
	lcall	_delay_function
...
;	nrf24l01.c:619: case PTX:
	sjmp	00107$
00104$:
;	nrf24l01.c:620: nrf24_CE(CE_ON);
	mov	dpl, #0x01
	push	ar7
	lcall	_nrf24_CE
;	nrf24l01.c:621: register_new_value = ((register_current_value) | (1 << PWR_UP)) & (~(1 << PRIM_RX));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	orl	a,#0x02
	mov	dptr,#_register_new_value
...
;	nrf24l01.c:629: default:
	sjmp	00107$
00106$:
;	nrf24l01.c:630: nrf24_CE(CE_OFF);
	mov	dpl, #0x00
	push	ar7
	lcall	_nrf24_CE
;	nrf24l01.c:631: register_new_value = (register_current_value) & (~(1 << PWR_UP));
	mov	dptr,#_register_current_value
	movx	a,@dptr
	mov	dptr,#_register_new_value
	anl	a,#0xfd
	movx	@dptr,a
;	nrf24l01.c:632: delay_function(POWER_DOWN_DELAY);
	mov	dptr,#0x0002
	clr	a
	mov	b,a
	lcall	_delay_function
...
;	nrf24l01.c:634: }
00107$:
;	nrf24l01.c:635: nrf24_write(CONFIG_ADDRESS, &register_new_value, 1, CLOSE);
	mov	dptr,#_nrf24_write_PARM_2
	mov	a,#_register_new_value
	movx	@dptr,a
	mov	a,#(_register_new_value >> 8)
	...
	lcall	_nrf24_write
	pop	ar7
;	nrf24l01.c:636: current_mode = mode;
	mov	dptr,#_current_mode
	mov	a,r7
	movx	@dptr,a
;	nrf24l01.c:637: }
...
;address                   Allocated with name '_nrf24_read_address_10000_207'
;------------------------------------------------------------
;	nrf24l01.c:641: void nrf24_read(uint8_t address, uint8_t *value, uint8_t data_length, uint8_t spi_state)
;	-----------------------------------------
;	 function nrf24_read
;	-----------------------------------------
_nrf24_read:
	mov	a,dpl
	mov	dptr,#_nrf24_read_address_10000_207
	movx	@dptr,a
;	nrf24l01.c:643: nrf24_SPI(SPI_ON);
	mov	dpl, #0x00
	lcall	_nrf24_SPI
;	nrf24l01.c:646: SPI_command = R_REGISTER | address;    /*in order to read CONFIG, then change one bit*/
	mov	dptr,#_nrf24_read_address_10000_207
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_SPI_command
	movx	@dptr,a
;	nrf24l01.c:647: SPI_send_command(SPI_command);
	mov	dpl, r7
	lcall	_SPI_send_command
;	nrf24l01.c:649: SPI_command = 0;
	mov	dptr,#_SPI_command
	clr	a
	movx	@dptr,a
	mov	dptr,#_nrf24_read_PARM_2
	...
	mov	r4,a
00105$:
;	nrf24l01.c:650: for (; data_length ; data_length--)
	mov	a,r4
	jz	00101$
;	nrf24l01.c:652: *value = SPI_send_command(SPI_command);
	mov	dptr,#_SPI_command
	movx	a,@dptr
	mov	dpl,a
	push	ar7
	...
	mov	r5,dpl
	mov	r6,dph
;	nrf24l01.c:653: value++;
;	nrf24l01.c:650: for (; data_length ; data_length--)
	dec	r4
	sjmp	00105$
00101$:
;	nrf24l01.c:655: if (spi_state == CLOSE)
	mov	dptr,#_nrf24_read_PARM_4
	movx	a,@dptr
	jnz	00107$
;	nrf24l01.c:656: nrf24_SPI(SPI_OFF);
	mov	dpl, #0x01
;	nrf24l01.c:657: }
	ljmp	_nrf24_SPI
00107$:
...
;address                   Allocated with name '_nrf24_write_address_10000_211'
;------------------------------------------------------------
;	nrf24l01.c:661: void nrf24_write(uint8_t address, uint8_t *value, uint8_t data_length, uint8_t spi_state)
;	-----------------------------------------
;	 function nrf24_write
;	-----------------------------------------
_nrf24_write:
	mov	a,dpl
	mov	dptr,#_nrf24_write_address_10000_211
	movx	@dptr,a
;	nrf24l01.c:663: nrf24_SPI(SPI_ON);
	mov	dpl, #0x00
	lcall	_nrf24_SPI
;	nrf24l01.c:664: SPI_command = W_REGISTER | address;    /*in order to read CONFIG, then change one bit*/
	mov	dptr,#_nrf24_write_address_10000_211
	movx	a,@dptr
	orl	a,#0x20
	mov	r7,a
	mov	dptr,#_SPI_command
	movx	@dptr,a
;	nrf24l01.c:665: SPI_send_command(SPI_command);
	mov	dpl, r7
	lcall	_SPI_send_command
	mov	dptr,#_nrf24_write_PARM_2
	movx	a,@dptr
	...
	mov	r4,a
00105$:
;	nrf24l01.c:666: for (; data_length ; data_length--)
	mov	a,r4
	jz	00101$
;	nrf24l01.c:668: SPI_command = *value;
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
	...
	mov	a,r3
	movx	@dptr,a
;	nrf24l01.c:669: value++;
;	nrf24l01.c:670: SPI_send_command(SPI_command);
	movx	a,@dptr
	mov	dpl,a
	push	ar7
	push	ar6
...
;	nrf24l01.c:666: for (; data_length ; data_length--)
	...
	sjmp	00105$
00101$:
;	nrf24l01.c:672: if (spi_state == CLOSE)
	mov	dptr,#_nrf24_write_PARM_4
	movx	a,@dptr
	jnz	00107$
;	nrf24l01.c:673: nrf24_SPI(SPI_OFF);
	mov	dpl, #0x01
;	nrf24l01.c:674: }
	ljmp	_nrf24_SPI
00107$:
