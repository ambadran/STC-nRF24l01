      ...
      000000                        883 _uartGetCharacter_result_10000_50:
      000000                        884 	.ds 1
      000001                        885 _delay1ms_ms_10000_84:
      000001                        886 	.ds 2
      000003                        887 _delay10us_us_10000_90:
      000003                        888 	.ds 1
      000004                        889 _delay1us_us_10000_96:
      000004                        890 	.ds 2
                                    891 ;--------------------------------------------------------
                                    ...
                                    895 ;--------------------------------------------------------
                                    896 ; initialized external ram data
                                    897 ;--------------------------------------------------------
                                    ...
                                    927 ;------------------------------------------------------------
                                    928 ;ms                        Allocated with name '_delay1ms_ms_10000_84'
                                    929 ;i                         Allocated with name '_delay1ms_i_20000_86'
                                    930 ;n                         Allocated with name '_delay1ms_n_40000_88'
                                    931 ;------------------------------------------------------------
                                    932 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:158: void delay1ms(uint16_t ms) {
                                    933 ;	-----------------------------------------
                                    934 ;	 function delay1ms
                                    935 ;	-----------------------------------------
      0000E8                        936 _delay1ms:
                           000007   937 	ar7 = 0x07
                           000006   938 	ar6 = 0x06
                           000005   939 	ar5 = 0x05
                           000004   940 	ar4 = 0x04
                           ...
                           000001   943 	ar1 = 0x01
                           000000   944 	ar0 = 0x00
      0000E8 AF 83            [24]  945 	mov	r7,dph
      0000EA E5 82            [12]  946 	mov	a,dpl
      0000EC 90 00 01         [24]  947 	mov	dptr,#_delay1ms_ms_10000_84
      0000EF F0               [24]  948 	movx	@dptr,a
      0000F0 EF               [12]  949 	mov	a,r7
      0000F1 A3               [24]  950 	inc	dptr
      0000F2 F0               [24]  951 	movx	@dptr,a
                                    952 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:159: for (uint16_t i = ms; i; i--) {
      0000F3 90 00 01         [24]  953 	mov	dptr,#_delay1ms_ms_10000_84
      0000F6 E0               [24]  954 	movx	a,@dptr
      0000F7 FE               [12]  955 	mov	r6,a
      0000F8 A3               [24]  956 	inc	dptr
      0000F9 E0               [24]  957 	movx	a,@dptr
      0000FA FF               [12]  958 	mov	r7,a
      0000FB                        959 00107$:
      0000FB EE               [12]  960 	mov	a,r6
      0000FC 4F               [12]  961 	orl	a,r7
      0000FD 60 19            [24]  962 	jz	00109$
                                    963 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:160: for (uint16_t n = DELAY_1ms; n; n--) {
      0000FF 7C 82            [12]  964 	mov	r4,#0x82
      000101 7D 0A            [12]  965 	mov	r5,#0x0a
      000103                        966 00104$:
      000103 EC               [12]  967 	mov	a,r4
      000104 4D               [12]  968 	orl	a,r5
      000105 60 0A            [24]  969 	jz	00108$
                                    970 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:161: NOP();
      000107 00               [12]  971 	NOP	
                                    972 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:162: NOP();
      000108 00               [12]  973 	NOP	
                                    974 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:163: NOP();
      000109 00               [12]  975 	NOP	
                                    976 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:160: for (uint16_t n = DELAY_1ms; n; n--) {
      00010A 1C               [12]  977 	dec	r4
      00010B BC FF 01         [24]  978 	cjne	r4,#0xff,00139$
      00010E 1D               [12]  979 	dec	r5
      00010F                        980 00139$:
      00010F 80 F2            [24]  981 	sjmp	00104$
      000111                        982 00108$:
                                    983 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:159: for (uint16_t i = ms; i; i--) {
      000111 1E               [12]  984 	dec	r6
      000112 BE FF 01         [24]  985 	cjne	r6,#0xff,00140$
      000115 1F               [12]  986 	dec	r7
      000116                        987 00140$:
      000116 80 E3            [24]  988 	sjmp	00107$
      000118                        989 00109$:
                                    990 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:166: }
      000118 22               [24]  991 	ret
                                    992 ;------------------------------------------------------------
                                    993 ;Allocation info for local variables in function 'delay10us'
                                    994 ;------------------------------------------------------------
                                    995 ;us                        Allocated with name '_delay10us_us_10000_90'
                                    996 ;i                         Allocated with name '_delay10us_i_20000_92'
                                    997 ;n                         Allocated with name '_delay10us_n_40000_94'
                                    998 ;------------------------------------------------------------
                                    999 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:167: void delay10us(uint8_t us) {
                                   1000 ;	-----------------------------------------
                                   1001 ;	 function delay10us
                                   1002 ;	-----------------------------------------
      000119                       1003 _delay10us:
      000119 E5 82            [12] 1004 	mov	a,dpl
      00011B 90 00 03         [24] 1005 	mov	dptr,#_delay10us_us_10000_90
      00011E F0               [24] 1006 	movx	@dptr,a
                                   1007 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:168: for (uint8_t i = us; i; i--) {
      00011F E0               [24] 1008 	movx	a,@dptr
      000120 FF               [12] 1009 	mov	r7,a
      000121                       1010 00107$:
      000121 EF               [12] 1011 	mov	a,r7
      000122 60 0B            [24] 1012 	jz	00109$
                                   1013 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:169: for (uint8_t n = DELAY_10us; n; n--) {
      000124 7E 37            [12] 1014 	mov	r6,#0x37
      000126                       1015 00104$:
      000126 EE               [12] 1016 	mov	a,r6
      000127 60 03            [24] 1017 	jz	00108$
      000129 1E               [12] 1018 	dec	r6
      00012A 80 FA            [24] 1019 	sjmp	00104$
      00012C                       1020 00108$:
                                   1021 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:168: for (uint8_t i = us; i; i--) {
      00012C 1F               [12] 1022 	dec	r7
      00012D 80 F2            [24] 1023 	sjmp	00107$
      00012F                       1024 00109$:
                                   1025 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:172: }
      00012F 22               [24] 1026 	ret
                                   1027 ;------------------------------------------------------------
                                   1028 ;Allocation info for local variables in function 'delay1us'
                                   1029 ;------------------------------------------------------------
                                   1030 ;us                        Allocated with name '_delay1us_us_10000_96'
                                   1031 ;i                         Allocated with name '_delay1us_i_20000_98'
                                   1032 ;n                         Allocated with name '_delay1us_n_40000_100'
                                   1033 ;------------------------------------------------------------
                                   1034 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:195: void delay1us(uint16_t us) {
                                   1035 ;	-----------------------------------------
                                   1036 ;	 function delay1us
                                   1037 ;	-----------------------------------------
      000130                       1038 _delay1us:
      000130 AF 83            [24] 1039 	mov	r7,dph
      000132 E5 82            [12] 1040 	mov	a,dpl
      000134 90 00 04         [24] 1041 	mov	dptr,#_delay1us_us_10000_96
      000137 F0               [24] 1042 	movx	@dptr,a
      000138 EF               [12] 1043 	mov	a,r7
      000139 A3               [24] 1044 	inc	dptr
      00013A F0               [24] 1045 	movx	@dptr,a
                                   1046 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:196: for (uint16_t i = us; i; i--) {
      00013B 90 00 04         [24] 1047 	mov	dptr,#_delay1us_us_10000_96
      00013E E0               [24] 1048 	movx	a,@dptr
      00013F FE               [12] 1049 	mov	r6,a
      000140 A3               [24] 1050 	inc	dptr
      000141 E0               [24] 1051 	movx	a,@dptr
      000142 FF               [12] 1052 	mov	r7,a
      000143                       1053 00107$:
      000143 EE               [12] 1054 	mov	a,r6
      000144 4F               [12] 1055 	orl	a,r7
      000145 60 10            [24] 1056 	jz	00109$
                                   1057 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:197: for (uint8_t n = DELAY_1us; n; n--) {
      000147 7D 05            [12] 1058 	mov	r5,#0x05
      000149                       1059 00104$:
      000149 ED               [12] 1060 	mov	a,r5
      00014A 60 03            [24] 1061 	jz	00101$
      00014C 1D               [12] 1062 	dec	r5
      00014D 80 FA            [24] 1063 	sjmp	00104$
      00014F                       1064 00101$:
                                   1065 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:200: NOP();
      00014F 00               [12] 1066 	NOP	
                                   1067 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:196: for (uint16_t i = us; i; i--) {
      000150 1E               [12] 1068 	dec	r6
      000151 BE FF 01         [24] 1069 	cjne	r6,#0xff,00139$
      000154 1F               [12] 1070 	dec	r7
      000155                       1071 00139$:
      000155 80 EC            [24] 1072 	sjmp	00107$
      000157                       1073 00109$:
                                   1074 ;	/Users/ambadran717/.stc/uni-stc/hal/delay.c:202: }
      000157 22               [24] 1075 	ret
                                   1076 	.area CSEG    (CODE)
