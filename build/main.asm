...
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
;	main.c:7: INIT_EXTENDED_SFR();
	orl	_P_SW2,#0x80
;	main.c:10: EA = 1;
;	assignBit
	setb	_EA
;	main.c:14: CONSOLE_PIN_CONFIG
...
;	main.c:17: global_timer_init();
	lcall	_global_timer_init
;	main.c:18: report_init();
	lcall	_report_init
;	main.c:19: nrf24_device(RECEIVER, RESET);
	mov	dptr,#_nrf24_device_PARM_2
	mov	a,#0x01
	movx	@dptr,a
	mov	dpl,#0x01
	lcall	_nrf24_device
;	main.c:21: delay1ms(500);
	mov	dptr,#0x01f4
	lcall	_delay1ms
;	main.c:24: protocol_main_loop();
;	main.c:26: }
	ljmp	_protocol_main_loop
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
