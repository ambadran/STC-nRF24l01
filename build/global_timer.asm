...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'global_timer_init'
;------------------------------------------------------------
;	global_timer.c:5: void global_timer_init(void) {
;	-----------------------------------------
...
_global_timer_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	global_timer.c:11: FREE_RUNNING
...
;	global_timer.c:13: }
	ljmp	_startTimer
;------------------------------------------------------------
;Allocation info for local variables in function 'get_current_time'
;------------------------------------------------------------
;	global_timer.c:15: uint32_t get_current_time(void) { return global_timer_counter; }
;	-----------------------------------------
;	 function get_current_time
;	-----------------------------------------
_get_current_time:
	mov	dptr,#_global_timer_counter
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	movx	a,@dptr
...
;------------------------------------------------------------
;	global_timer.c:18: INTERRUPT(GLOBAL_TIMER_ISR, GLOBAL_TIMER_INTERRUPT) {
;	-----------------------------------------
;	 function timer0_isr
;	-----------------------------------------
_timer0_isr:
	...
	push	psw
	mov	psw,#0x00
;	global_timer.c:20: global_timer_counter++;
	mov	dptr,#_global_timer_counter
	movx	a,@dptr
	mov	r4,a
	inc	dptr
