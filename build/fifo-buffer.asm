...
_uartGetCharacter_result_65536_69:
	.ds 1
_fifoClear_buffer_65536_131:
	.ds 3
_fifoIsFull_fifo_65536_133:
	.ds 3
_fifoBytesFree_fifo_65536_138:
	.ds 3
;--------------------------------------------------------
...
;------------------------------------------------------------
;buffer                    Allocated with name '_fifoClear_buffer_65536_131'
;------------------------------------------------------------
...
_fifoClear:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_fifoClear_buffer_65536_131
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;fifo                      Allocated with name '_fifoIsFull_fifo_65536_133'
;__1310720008              Allocated with name '_fifoIsFull___1310720008_131072_134'
;__1310720009              Allocated with name '_fifoIsFull___1310720009_131072_135'
;buffer                    Allocated with name '_fifoIsFull_buffer_196608_136'
;------------------------------------------------------------
...
_fifoIsFull:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_fifoIsFull_fifo_65536_133
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;fifo                      Allocated with name '_fifoBytesFree_fifo_65536_138'
;__1310720011              Allocated with name '_fifoBytesFree___1310720011_131072_139'
;__1310720012              Allocated with name '_fifoBytesFree___1310720012_131072_140'
;buffer                    Allocated with name '_fifoBytesFree_buffer_196608_141'
;------------------------------------------------------------
...
_fifoBytesFree:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_fifoBytesFree_fifo_65536_138
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
