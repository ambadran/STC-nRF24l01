...
_uartGetCharacter_result_65536_74:
	.ds 1
_delay1ms_ms_65536_113:
	.ds 2
_delay10us_us_65536_119:
	.ds 1
_delay1us_us_65536_125:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;ms                        Allocated with name '_delay1ms_ms_65536_113'
;i                         Allocated with name '_delay1ms_i_131072_115'
;n                         Allocated with name '_delay1ms_n_262144_117'
;------------------------------------------------------------
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:158: void delay1ms(uint16_t ms) {
;	-----------------------------------------
;	 function delay1ms
;	-----------------------------------------
_delay1ms:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay1ms_ms_65536_113
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:159: for (uint16_t i = ms; i; i--) {
	mov	dptr,#_delay1ms_ms_65536_113
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00107$:
	...
	orl	a,r7
	jz	00109$
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:160: for (uint16_t n = DELAY_1ms; n; n--) {
	mov	r4,#0x82
	mov	r5,#0x0a
00104$:
	mov	a,r4
	orl	a,r5
	jz	00108$
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:161: NOP();
	NOP	
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:162: NOP();
	NOP	
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:163: NOP();
	NOP	
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:160: for (uint16_t n = DELAY_1ms; n; n--) {
	dec	r4
	cjne	r4,#0xff,00131$
...
00132$:
	sjmp	00107$
00109$:
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:166: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'delay10us'
;------------------------------------------------------------
;us                        Allocated with name '_delay10us_us_65536_119'
;i                         Allocated with name '_delay10us_i_131072_121'
;n                         Allocated with name '_delay10us_n_262144_123'
;------------------------------------------------------------
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:167: void delay10us(uint8_t us) {
;	-----------------------------------------
;	 function delay10us
;	-----------------------------------------
_delay10us:
	mov	a,dpl
	mov	dptr,#_delay10us_us_65536_119
	movx	@dptr,a
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:168: for (uint8_t i = us; i; i--) {
	movx	a,@dptr
	mov	r7,a
00107$:
	mov	a,r7
	jz	00109$
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:169: for (uint8_t n = DELAY_10us; n; n--) {
	mov	r6,#0x37
00104$:
	mov	a,r6
	jz	00108$
...
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:168: for (uint8_t i = us; i; i--) {
	...
	sjmp	00107$
00109$:
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:172: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'delay1us'
;------------------------------------------------------------
;us                        Allocated with name '_delay1us_us_65536_125'
;i                         Allocated with name '_delay1us_i_131072_127'
;n                         Allocated with name '_delay1us_n_262144_129'
;------------------------------------------------------------
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:195: void delay1us(uint16_t us) {
;	-----------------------------------------
;	 function delay1us
;	-----------------------------------------
_delay1us:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay1us_us_65536_125
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:196: for (uint16_t i = us; i; i--) {
	mov	dptr,#_delay1us_us_65536_125
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00107$:
	...
	orl	a,r7
	jz	00109$
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:197: for (uint8_t n = DELAY_1us; n; n--) {
	mov	r5,#0x05
00104$:
	mov	a,r5
	jz	00101$
	...
	sjmp	00104$
00101$:
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:200: NOP();
	NOP	
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:196: for (uint16_t i = us; i; i--) {
	dec	r6
	cjne	r6,#0xff,00131$
...
00131$:
	sjmp	00107$
00109$:
;	/home/mr-atom/.stc/uni-stc/hal/delay.c:202: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
