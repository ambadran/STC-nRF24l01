...
_uartGetCharacter_result_65536_32:
	.ds 1
_delay1ms_ms_65536_51:
	.ds 2
_delay10us_us_65536_57:
	.ds 1
_delay1us_us_65536_63:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;ms                        Allocated with name '_delay1ms_ms_65536_51'
;i                         Allocated with name '_delay1ms_i_131072_53'
;n                         Allocated with name '_delay1ms_n_262144_55'
;------------------------------------------------------------
...
_delay1ms:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay1ms_ms_65536_51
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;us                        Allocated with name '_delay10us_us_65536_57'
;i                         Allocated with name '_delay10us_i_131072_59'
;n                         Allocated with name '_delay10us_n_262144_61'
;------------------------------------------------------------
...
_delay10us:
	mov	a,dpl
	mov	dptr,#_delay10us_us_65536_57
	movx	@dptr,a
...
;------------------------------------------------------------
;us                        Allocated with name '_delay1us_us_65536_63'
;i                         Allocated with name '_delay1us_i_131072_65'
;n                         Allocated with name '_delay1us_n_262144_67'
;------------------------------------------------------------
...
_delay1us:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay1us_us_65536_63
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
