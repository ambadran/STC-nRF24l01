...
;------------------------------------------------------------
;	gpio_settings.c:6: void gpio_init(void) {
;	-----------------------------------------
;	 function gpio_init
;	-----------------------------------------
_gpio_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	gpio_settings.c:8: gpioConfigure(&test_Pin);
	mov	dptr,#_test_Pin
	mov	b,#0x00
	lcall	_gpioConfigure
;	gpio_settings.c:9: test_pin_off();
;	gpio_settings.c:11: return;
;	gpio_settings.c:12: }
	ljmp	_test_pin_off
;------------------------------------------------------------
;Allocation info for local variables in function 'test_pin_on'
;------------------------------------------------------------
;	gpio_settings.c:14: void test_pin_on(void) {
;	-----------------------------------------
;	 function test_pin_on
;	-----------------------------------------
_test_pin_on:
;	gpio_settings.c:15: gpioWrite(&test_Pin, 1);
...
;	gpio_settings.c:16: }
	ljmp	_gpioWrite
;------------------------------------------------------------
;Allocation info for local variables in function 'test_pin_off'
;------------------------------------------------------------
;	gpio_settings.c:18: void test_pin_off(void) {
;	-----------------------------------------
;	 function test_pin_off
;	-----------------------------------------
_test_pin_off:
;	gpio_settings.c:19: gpioWrite(&test_Pin, 0);
	mov	dptr,#_gpioWrite_PARM_2
	clr	a
	movx	@dptr,a
	mov	dptr,#_test_Pin
