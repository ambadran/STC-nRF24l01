...
;------------------------------------------------------------
;	gpio_settings.c:4: void gpio_init(void) {
;	-----------------------------------------
;	 function gpio_init
;	-----------------------------------------
_gpio_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	gpio_settings.c:8: gpio_pin_init(&test_pin, GPIO_PORT2, GPIO_PIN5, GPIO_BIDIRECTIONAL_MODE);
	...
	mov	dptr,#_test_pin
	mov	b,#0x00
	lcall	_gpio_pin_init
;	gpio_settings.c:9: gpioConfigure(&test_pin);
	mov	dptr,#_test_pin
	mov	b,#0x00
	lcall	_gpioConfigure
;	gpio_settings.c:11: test_p = 1;
	mov	dptr,#_test_p
	mov	a,#0x01
	movx	@dptr,a
;	gpio_settings.c:13: return;
;	gpio_settings.c:14: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
