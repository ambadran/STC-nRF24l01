      ...
      000077                        883 _uartGetCharacter_result_65536_32:
      000077                        884 	.ds 1
      000078                        885 _delay1ms_ms_65536_51:
      000078                        886 	.ds 2
      00007A                        887 _delay10us_us_65536_57:
      00007A                        888 	.ds 1
      00007B                        889 _delay1us_us_65536_63:
      00007B                        890 	.ds 2
                                    891 ;--------------------------------------------------------
                                    ...
                                    927 ;------------------------------------------------------------
                                    928 ;ms                        Allocated with name '_delay1ms_ms_65536_51'
                                    929 ;i                         Allocated with name '_delay1ms_i_131072_53'
                                    930 ;n                         Allocated with name '_delay1ms_n_262144_55'
                                    931 ;------------------------------------------------------------
                                    932 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:158: void delay1ms(uint16_t ms) {
                                    933 ;	-----------------------------------------
                                    934 ;	 function delay1ms
                                    935 ;	-----------------------------------------
      001867                        936 _delay1ms:
                           000007   937 	ar7 = 0x07
                           000006   938 	ar6 = 0x06
                           000005   939 	ar5 = 0x05
                           000004   940 	ar4 = 0x04
                           ...
                           000001   943 	ar1 = 0x01
                           000000   944 	ar0 = 0x00
      001867 AF 83            [24]  945 	mov	r7,dph
      001869 E5 82            [12]  946 	mov	a,dpl
      00186B 90 00 78         [24]  947 	mov	dptr,#_delay1ms_ms_65536_51
      00186E F0               [24]  948 	movx	@dptr,a
      00186F EF               [12]  949 	mov	a,r7
      001870 A3               [24]  950 	inc	dptr
      001871 F0               [24]  951 	movx	@dptr,a
                                    952 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:159: for (uint16_t i = ms; i; i--) {
      001872 90 00 78         [24]  953 	mov	dptr,#_delay1ms_ms_65536_51
      001875 E0               [24]  954 	movx	a,@dptr
      001876 FE               [12]  955 	mov	r6,a
      001877 A3               [24]  956 	inc	dptr
      001878 E0               [24]  957 	movx	a,@dptr
      001879 FF               [12]  958 	mov	r7,a
      00187A                        959 00107$:
      00187A EE               [12]  960 	mov	a,r6
      00187B 4F               [12]  961 	orl	a,r7
      00187C 60 19            [24]  962 	jz	00109$
                                    963 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:160: for (uint16_t n = DELAY_1ms; n; n--) {
      00187E 7C 82            [12]  964 	mov	r4,#0x82
      001880 7D 0A            [12]  965 	mov	r5,#0x0a
      001882                        966 00104$:
      001882 EC               [12]  967 	mov	a,r4
      001883 4D               [12]  968 	orl	a,r5
      001884 60 0A            [24]  969 	jz	00108$
                                    970 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:161: NOP();
      001886 00               [12]  971 	NOP	
                                    972 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:162: NOP();
      001887 00               [12]  973 	NOP	
                                    974 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:163: NOP();
      001888 00               [12]  975 	NOP	
                                    976 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:160: for (uint16_t n = DELAY_1ms; n; n--) {
      001889 1C               [12]  977 	dec	r4
      00188A BC FF 01         [24]  978 	cjne	r4,#0xff,00131$
      00188D 1D               [12]  979 	dec	r5
      00188E                        980 00131$:
      00188E 80 F2            [24]  981 	sjmp	00104$
      001890                        982 00108$:
                                    983 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:159: for (uint16_t i = ms; i; i--) {
      001890 1E               [12]  984 	dec	r6
      001891 BE FF 01         [24]  985 	cjne	r6,#0xff,00132$
      001894 1F               [12]  986 	dec	r7
      001895                        987 00132$:
      001895 80 E3            [24]  988 	sjmp	00107$
      001897                        989 00109$:
                                    990 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:166: }
      001897 22               [24]  991 	ret
                                    992 ;------------------------------------------------------------
                                    993 ;Allocation info for local variables in function 'delay10us'
                                    994 ;------------------------------------------------------------
                                    995 ;us                        Allocated with name '_delay10us_us_65536_57'
                                    996 ;i                         Allocated with name '_delay10us_i_131072_59'
                                    997 ;n                         Allocated with name '_delay10us_n_262144_61'
                                    998 ;------------------------------------------------------------
                                    999 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:167: void delay10us(uint8_t us) {
                                   1000 ;	-----------------------------------------
                                   1001 ;	 function delay10us
                                   1002 ;	-----------------------------------------
      001898                       1003 _delay10us:
      001898 E5 82            [12] 1004 	mov	a,dpl
      00189A 90 00 7A         [24] 1005 	mov	dptr,#_delay10us_us_65536_57
      00189D F0               [24] 1006 	movx	@dptr,a
                                   1007 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:168: for (uint8_t i = us; i; i--) {
      00189E E0               [24] 1008 	movx	a,@dptr
      00189F FF               [12] 1009 	mov	r7,a
      0018A0                       1010 00107$:
      0018A0 EF               [12] 1011 	mov	a,r7
      0018A1 60 0B            [24] 1012 	jz	00109$
                                   1013 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:169: for (uint8_t n = DELAY_10us; n; n--) {
      0018A3 7E 37            [12] 1014 	mov	r6,#0x37
      0018A5                       1015 00104$:
      0018A5 EE               [12] 1016 	mov	a,r6
      0018A6 60 03            [24] 1017 	jz	00108$
      0018A8 1E               [12] 1018 	dec	r6
      0018A9 80 FA            [24] 1019 	sjmp	00104$
      0018AB                       1020 00108$:
                                   1021 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:168: for (uint8_t i = us; i; i--) {
      0018AB 1F               [12] 1022 	dec	r7
      0018AC 80 F2            [24] 1023 	sjmp	00107$
      0018AE                       1024 00109$:
                                   1025 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:172: }
      0018AE 22               [24] 1026 	ret
                                   1027 ;------------------------------------------------------------
                                   1028 ;Allocation info for local variables in function 'delay1us'
                                   1029 ;------------------------------------------------------------
                                   1030 ;us                        Allocated with name '_delay1us_us_65536_63'
                                   1031 ;i                         Allocated with name '_delay1us_i_131072_65'
                                   1032 ;n                         Allocated with name '_delay1us_n_262144_67'
                                   1033 ;------------------------------------------------------------
                                   1034 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:195: void delay1us(uint16_t us) {
                                   1035 ;	-----------------------------------------
                                   1036 ;	 function delay1us
                                   1037 ;	-----------------------------------------
      0018AF                       1038 _delay1us:
      0018AF AF 83            [24] 1039 	mov	r7,dph
      0018B1 E5 82            [12] 1040 	mov	a,dpl
      0018B3 90 00 7B         [24] 1041 	mov	dptr,#_delay1us_us_65536_63
      0018B6 F0               [24] 1042 	movx	@dptr,a
      0018B7 EF               [12] 1043 	mov	a,r7
      0018B8 A3               [24] 1044 	inc	dptr
      0018B9 F0               [24] 1045 	movx	@dptr,a
                                   1046 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:196: for (uint16_t i = us; i; i--) {
      0018BA 90 00 7B         [24] 1047 	mov	dptr,#_delay1us_us_65536_63
      0018BD E0               [24] 1048 	movx	a,@dptr
      0018BE FE               [12] 1049 	mov	r6,a
      0018BF A3               [24] 1050 	inc	dptr
      0018C0 E0               [24] 1051 	movx	a,@dptr
      0018C1 FF               [12] 1052 	mov	r7,a
      0018C2                       1053 00107$:
      0018C2 EE               [12] 1054 	mov	a,r6
      0018C3 4F               [12] 1055 	orl	a,r7
      0018C4 60 10            [24] 1056 	jz	00109$
                                   1057 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:197: for (uint8_t n = DELAY_1us; n; n--) {
      0018C6 7D 05            [12] 1058 	mov	r5,#0x05
      0018C8                       1059 00104$:
      0018C8 ED               [12] 1060 	mov	a,r5
      0018C9 60 03            [24] 1061 	jz	00101$
      0018CB 1D               [12] 1062 	dec	r5
      0018CC 80 FA            [24] 1063 	sjmp	00104$
      0018CE                       1064 00101$:
                                   1065 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:200: NOP();
      0018CE 00               [12] 1066 	NOP	
                                   1067 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:196: for (uint16_t i = us; i; i--) {
      0018CF 1E               [12] 1068 	dec	r6
      0018D0 BE FF 01         [24] 1069 	cjne	r6,#0xff,00131$
      0018D3 1F               [12] 1070 	dec	r7
      0018D4                       1071 00131$:
      0018D4 80 EC            [24] 1072 	sjmp	00107$
      0018D6                       1073 00109$:
                                   1074 ;	/home/mr-atom/.stc/uni-stc/hal/delay.c:202: }
      0018D6 22               [24] 1075 	ret
                                   1076 	.area CSEG    (CODE)
