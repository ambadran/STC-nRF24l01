...
;	main.c:7: INIT_EXTENDED_SFR();
	orl	_P_SW2,#0x80
;	main.c:8: interrupts_init();
;	assignBit
	setb	_EA
;	main.c:12: CONSOLE_PIN_CONFIG
...
;	main.c:17: while (1) {
00102$:
;	main.c:19: gpioWrite(&test_pin, 0);
	...
	mov	b,#0x00
	lcall	_gpioWrite
;	main.c:20: delay1ms(30);
	mov	dptr,#0x001e
	lcall	_delay1ms
;	main.c:21: gpioWrite(&test_pin, 1);
	mov	dptr,#_gpioWrite_PARM_2
	mov	a,#0x01
	movx	@dptr,a
	mov	dptr,#_test_pin
