...
_uartGetCharacter_result_65536_74:
	.ds 1
_main_initial_char_65537_115:
	.ds 1
_main_result_327681_124:
	.ds 1
_main_received_payload_65538_117:
	.ds 1
_main_led_state_65538_117:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;initial_char              Allocated with name '_main_initial_char_65537_115'
;__1966090007              Allocated with name '_main___1966090007_196609_116'
;__1966090008              Allocated with name '_main___1966090008_196609_122'
;__1966090009              Allocated with name '_main___1966090009_196609_122'
;uart                      Allocated with name '_main_uart_262145_123'
;blocking                  Allocated with name '_main_blocking_262145_123'
;result                    Allocated with name '_main_result_327681_124'
;received_payload          Allocated with name '_main_received_payload_65538_117'
;led_state                 Allocated with name '_main_led_state_65538_117'
;------------------------------------------------------------
...
;	main.c:16: uint8_t initial_char = '0';
	mov	dptr,#_main_initial_char_65537_115
	mov	a,#0x30
	movx	@dptr,a
...
;	main.c:28: while (1) {
00112$:
;	main.c:34: if (nrf24_receive(&received_payload, 1) != RECEIVE_FIFO_EMPTY) {  
	mov	dptr,#_nrf24_receive_PARM_2
	mov	a,#0x01
	movx	@dptr,a
	mov	dptr,#_main_received_payload_65538_117
	mov	b,#0x00
	...
	sjmp	00105$
00142$:
;	main.c:35: printf("\rReceived Value: %c\n", received_payload);
	mov	dptr,#_main_received_payload_65538_117
	movx	a,@dptr
	mov	r7,a
	mov	r6,#0x00
	...
	add	a,#0xfb
	mov	sp,a
;	main.c:36: led_state = received_payload;
	mov	dptr,#_main_received_payload_65538_117
	movx	a,@dptr
	mov	dptr,#_main_led_state_65538_117
	movx	@dptr,a
00105$:
;	main.c:39: if (led_state == '1') {
	mov	dptr,#_main_led_state_65538_117
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x31,00109$
;	main.c:40: test_pin_on();
	lcall	_test_pin_on
	sjmp	00112$
00109$:
;	main.c:41: } else if (led_state == '0') {
	cjne	r7,#0x30,00112$
;	main.c:42: test_pin_off();
	lcall	_test_pin_off
;	main.c:47: }
	sjmp	00112$
	.area CSEG    (CODE)
