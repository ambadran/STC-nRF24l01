...
___gpio_setBits_PARM_3:
	.ds 3
___gpio_setBits_portValue_65536_113:
	.ds 1
___isOutput_gpioConfig_65536_115:
	.ds 3
___isInput_gpioConfig_65536_117:
	.ds 3
...
_gpio_pin_init_PARM_4:
	.ds 1
_gpio_pin_init_config_65536_119:
	.ds 3
_gpioConfigure_gpioConfig_65536_121:
	.ds 3
_gpioConfigure_mask_65536_122:
	.ds 1
_gpioConfigure_pm1_65537_125:
	.ds 1
_gpioConfigure_pm0_65537_125:
	.ds 1
_gpioConfigure_pncs_65537_125:
	.ds 1
_gpioConfigure_ppu_65537_125:
	.ds 1
_gpioConfigure_pdr_65537_125:
	.ds 1
_gpioConfigure_psr_65537_125:
	.ds 1
_gpioConfigure_pie_65537_125:
	.ds 1
_gpioConfigure_pim1_65537_125:
	.ds 1
_gpioConfigure_pim0_65537_125:
	.ds 1
_gpioConfigure_pintf_65537_125:
	.ds 1
_gpioConfigure_pinte_65537_125:
	.ds 1
_gpioConfigure_pwkue_65537_125:
	.ds 1
___getPort_port_65536_130:
	.ds 1
___getPort_value_65536_131:
	.ds 1
_gpioRead_gpioConfig_65536_133:
	.ds 3
_gpioWrite_PARM_2:
	.ds 1
_gpioWrite_gpioConfig_65536_135:
	.ds 3
;--------------------------------------------------------
...
;portValue                 Allocated with name '___gpio_setBits_portValue_65536_113'
;------------------------------------------------------------
...
___gpio_setBits:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#___gpio_setBits_portValue_65536_113
	movx	@dptr,a
...
;------------------------------------------------------------
;gpioConfig                Allocated with name '___isOutput_gpioConfig_65536_115'
;------------------------------------------------------------
...
___isOutput:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#___isOutput_gpioConfig_65536_115
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;gpioConfig                Allocated with name '___isInput_gpioConfig_65536_117'
;------------------------------------------------------------
...
___isInput:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#___isInput_gpioConfig_65536_117
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;config                    Allocated with name '_gpio_pin_init_config_65536_119'
;------------------------------------------------------------
...
_gpio_pin_init:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_gpio_pin_init_config_65536_119
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;gpioConfig                Allocated with name '_gpioConfigure_gpioConfig_65536_121'
;mask                      Allocated with name '_gpioConfigure_mask_65536_122'
;n                         Allocated with name '_gpioConfigure_n_131072_123'
;pm1                       Allocated with name '_gpioConfigure_pm1_65537_125'
;pm0                       Allocated with name '_gpioConfigure_pm0_65537_125'
;pncs                      Allocated with name '_gpioConfigure_pncs_65537_125'
;ppu                       Allocated with name '_gpioConfigure_ppu_65537_125'
;pdr                       Allocated with name '_gpioConfigure_pdr_65537_125'
;psr                       Allocated with name '_gpioConfigure_psr_65537_125'
;pie                       Allocated with name '_gpioConfigure_pie_65537_125'
;pim1                      Allocated with name '_gpioConfigure_pim1_65537_125'
;pim0                      Allocated with name '_gpioConfigure_pim0_65537_125'
;pintf                     Allocated with name '_gpioConfigure_pintf_65537_125'
;pinte                     Allocated with name '_gpioConfigure_pinte_65537_125'
;pwkue                     Allocated with name '_gpioConfigure_pwkue_65537_125'
;------------------------------------------------------------
...
_gpioConfigure:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_gpioConfigure_gpioConfig_65536_121
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;	/home/mr-atom/.stc/uni-stc/hal/gpio-hal.c:78: uint8_t mask = 0;
	mov	dptr,#_gpioConfigure_mask_65536_122
	clr	a
	movx	@dptr,a
...
;------------------------------------------------------------
;port                      Allocated with name '___getPort_port_65536_130'
;value                     Allocated with name '___getPort_value_65536_131'
;------------------------------------------------------------
...
___getPort:
	mov	a,dpl
	mov	dptr,#___getPort_port_65536_130
	movx	@dptr,a
;	/home/mr-atom/.stc/uni-stc/hal/gpio-hal.c:587: uint8_t value = 0;
	mov	dptr,#___getPort_value_65536_131
	clr	a
	movx	@dptr,a
...
;------------------------------------------------------------
;gpioConfig                Allocated with name '_gpioRead_gpioConfig_65536_133'
;------------------------------------------------------------
...
_gpioRead:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_gpioRead_gpioConfig_65536_133
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;gpioConfig                Allocated with name '_gpioWrite_gpioConfig_65536_135'
;------------------------------------------------------------
...
_gpioWrite:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_gpioWrite_gpioConfig_65536_135
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
